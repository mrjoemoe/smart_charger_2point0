...
dc_volt = 280;          % DC Link Voltage
Lin = 1.5e-3;             % AC/DC input inductance
ESRLin = 0.2;           % AC/DC input inductance equivalent series resistance 
...
Ldcdc = 1.3e-3;         % DC/DC output filter inductance
...
pre_charge_r = 10;      %precharg resistance

Rbatt = 0.20;           % ideal battery terminal resistance
...
acdc_on_time = 0.2;
pre_charge_off = 0.2;
acdc_ramp_end_time = 0.5;
dcdc_on = 0.5;
active_power_on = 0.5;
reactive_power_on = 0.9;
